    ...
    <div id="wrapJ">
        ...
        <div id="contain">
            ...
            <form action="#" method="post" id="joinform">
            	<input type="hidden" name="INFO_POSITION" value="<%=ReadXml.getKeys("position_member")%>"/>
            	<input type="hidden" name="INFO_ADDSTORE" value="FALSE"/>
            	<input type="hidden" name="INFO_DELSTORE" value="FALSE"/>
            	<input type="hidden" name="INFO_MODSTORE" value="FALSE"/>
                <div class="input"><input type="text" name="INFO_EMAIL" placeholder="sidongblog@naver.com"/></div><!--이메일 input-->
                <div class="tr">
                    <div class="td_Button">중복확인</div><div class="tdR_Button">이메일 수신동의<input type="checkbox" name="" style="margin-left:15px;"/></div> <!--중복확인/수신동의 Button-->
                </div>
                ...
                <div class="input"><input type="text"maxlength=6 name="INFO_BIRTH" placeholder="생년월일을 입력해 주세요 ex)901225" /></div><!--생년월일 input-->
