...
<%
	...
	List list2 = (List) session.getAttribute("glist");
		String phone[] = {"0","0","0"};
    ...
    <div id="contain">
        ...
        <table id="tb" width=60% border="1" cellpadding="0" cellspacing="0">
            ...
            <tr valign="middle" bordercolor="#333333">
                ...
                <td><%for(int c=0;c<list2.size();c++) {
						GRADE_Bean bean2 = (GRADE_Bean) list2.get(c);
						if(bean2.getGRADE_NUM() == user.getINFO_GRADE()){
					%>
					<%= bean2.getGRADE_VAL()%>
					<%} }%></td>
            </tr>
